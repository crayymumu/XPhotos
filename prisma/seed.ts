...
const INITIAL_CONFIGS = [
  ...
  { config_key: 'oss_accesskey_id', config_value: '', detail: 'Aliyun OSS AccessKey ID' },
  { config_key: 'oss_accesskey_secret', config_value: '', detail: 'Aliyun OSS AccessKey Secret' },
  { config_key: 'oss_region', config_value: '', detail: 'Aliyun OSS Region，如：oss-cn-hangzhou' },
  { config_key: 'oss_endpoint', config_value: '', detail: 'Aliyun OSS Endpoint，如：https://oss-cn-hangzhou.aliyuncs.com' },
  { config_key: 'oss_bucket', config_value: '', detail: 'Aliyun OSS Bucket 名称' },
  { config_key: 'oss_storage_folder', config_value: '', detail: 'Aliyun OSS 存储文件夹，如：xphotos 或 xphotos/images' },
  { config_key: 'oss_cdn', config_value: 'false', detail: '是否启用 OSS CDN 模式，默认 false' },
  { config_key: 'oss_cdn_url', config_value: '', detail: 'Aliyun OSS CDN 地址，如：https://cdn.example.com' },
  { config_key: 'oss_direct_download', config_value: 'false', detail: '是否启用 OSS 直链下载模式，默认 false' },
